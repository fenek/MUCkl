...
var HTTPBASE = "ws://localhost:5288/ws-xmpp";
...
var MUCKLPASS='<?php echo $_COOKIE["wordpress_logged_in_".COOKIEHASH]; ?>';
var MUCKLNICK=<?php if ($auth_type=='saslanon') echo '0'; else echo "'".$user_login."'"; ?>;

//var MUCKLJID = "muckl"; // username
//var MUCKLPASS = "muckl"; // password
//var MUCKLNICK = "muckl"; // default nick for user
